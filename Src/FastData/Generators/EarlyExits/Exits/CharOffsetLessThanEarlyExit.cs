...
public sealed record CharOffsetLessThanEarlyExit(char Value, int Offset = 0) : MethodComparisonEarlyExitBase<char>(Value, nameof(StringFunctions.GetCharAt))
{
    ...
    public override bool IsWorseThan(IEarlyExit other) => other is CharOffsetLessThanEarlyExit otherExit && Offset == otherExit.Offset && Value < otherExit.Value;
}
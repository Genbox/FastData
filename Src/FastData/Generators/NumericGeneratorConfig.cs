...
{
    internal NumericGeneratorConfig(Type structureType, uint itemCount, object minValue, object maxValue, AnnotatedExpr[] earlyExits, bool typeReductionEnabled, bool hasZeroOrNaN) : base(structureType.GetFriendlyName(), earlyExits, itemCount, typeReductionEnabled)
    {

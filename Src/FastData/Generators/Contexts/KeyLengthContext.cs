...
public sealed class KeyLengthContext<TValue>(List<string>?[] lengths, bool lengthsAreUniq, uint minLength, uint maxLength, ValueSpec<TValue>? valueSpec) : IContext<TValue>
{

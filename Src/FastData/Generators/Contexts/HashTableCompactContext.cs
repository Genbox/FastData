...
public sealed class HashTableCompactContext<TKey, TValue>(int[] bucketStarts, int[] bucketCounts, HashTableCompactEntry<TKey>[] entries, bool storeHashCode, TValue[]? values) : IContext<TValue>
{

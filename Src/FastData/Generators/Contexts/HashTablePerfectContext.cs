...
public sealed class HashTablePerfectContext<TKey, TValue>(KeyValuePair<TKey, ulong>[] data, bool storeHashCode, ValueSpec<TValue>? values) : IContext<TValue>
{
    ...
    public ValueSpec<TValue>? ValueSpec { get; } = values;
}
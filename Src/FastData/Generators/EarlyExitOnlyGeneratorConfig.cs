...
public sealed class EarlyExitOnlyGeneratorConfig(AnnotatedExpr[] earlyExits, GeneratorFunction generatorFunctions) : GeneratorConfigBase("EarlyExitOnly", earlyExits, 0, false, StructureCapability.Membership)
{

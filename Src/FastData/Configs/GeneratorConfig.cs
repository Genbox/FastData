...
{
    internal GeneratorConfig(StructureType structureType, StringComparison stringComparison, DataProperties<T> props, IArrayHash arrayHash)
    {
    ...
    public IArrayHash ArrayHash { get; set; }

...
{
    internal GeneratorConfig(StructureType structureType, StringComparison stringComparison, DataProperties<T> props, IStringHash arrayHash)
    {
    ...
    public IStringHash ArrayHash { get; set; }

...
{
    internal static HashFunc<T> GetHash<T>(DataType dataType, bool use64BitHashing)
    {
        if (use64BitHashing)
        {
            return dataType switch
            {
                ...
                DataType.Double => static obj => HashF64_64((double)(object)obj), //Does not fold to 32bit
    ...
    private static ulong HashF64_64(double value)
    {
        ulong bits = Unsafe.ReadUnaligned<ulong>(ref Unsafe.As<double, byte>(ref value));

...
#if RELEASE
        sb.Append(_constDef.CommentString).Append(' ').AppendLine("Generated by: " + genCfg.Metadata.Program);
        sb.Append(_constDef.CommentString).Append(' ').AppendLine("Generated on: " + genCfg.Metadata.Timestamp);
#endif
    }

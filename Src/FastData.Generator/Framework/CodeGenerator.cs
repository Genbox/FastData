...
public abstract class CodeGenerator : ICodeGenerator
{
    ...
    protected virtual void AppendHeader<T>(StringBuilder sb, GeneratorConfig<T> genCfg, IContext context)
    {
        ...
        sb.Append(_constDef.Comment).Append(' ').AppendLine($"Structure: {genCfg.StructureType}{(genCfg.StructureType == StructureType.Auto ? $" ({context.GetType().Name.Replace("Context`1", "")})" : string.Empty)}");

...
public class CSharpCodeGenerator(CSharpGeneratorConfig userCfg) : IGenerator
{
    ...
    private void AppendFooter(GeneratorConfig genCfg, FastDataConfig fastCfg)
    {
        ...
        else if (type == KnownDataType.String)
        {
            ...
            _sb.Append("    public const ").Append(minType).Append(" MinLength = ").Append(genCfg.Constants.MinValue).AppendLine(";");
            _sb.Append("    public const ").Append(maxType).Append(" MaxLength = ").Append(genCfg.Constants.MaxValue).AppendLine(";");
        }

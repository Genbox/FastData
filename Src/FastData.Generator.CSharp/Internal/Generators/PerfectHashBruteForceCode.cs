...
internal sealed class PerfectHashBruteForceCode<T>(GeneratorConfig genCfg, CSharpCodeGeneratorConfig cfg, PerfectHashBruteForceContext<T> ctx) : IOutputWriter
{

...
internal sealed class HashTablePerfectCode<TKey, TValue>(HashTablePerfectContext<TKey, TValue> ctx, string className) : CPlusPlusOutputWriter<TKey, TValue>(ctx.Values, className)
{

...
public static class ArrayHashTest
{
    public static void Run()
    {
        ...
        Console.WriteLine(c.GetCode(new DefaultArrayHash().BuildExpression()));

        byte[] utf16 = Encoding.Unicode.GetBytes(str);
        byte[] utf8 = Encoding.UTF8.GetBytes(str);

        Console.WriteLine("utf16: " + new DefaultArrayHash().GetHashFunction()(ref utf16[0], utf16.Length));
        Console.WriteLine("utf8: " + new DefaultArrayHash().GetHashFunction()(ref utf8[0], utf8.Length));
